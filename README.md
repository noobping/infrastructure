...
[![OPA](https://github.com/noobping/infrastructure/actions/workflows/opa.yml/badge.svg)](https://github.com/noobping/infrastructure/actions/workflows/opa.yml)
...
From GNOME and Cinnamon workstations to headless servers and storage nodes, the entire stack is defined as code using Butane, bootable containers, and CI/CD pipelines.
